...
const styles = StyleSheet.create({
    ...
    modalContent: { backgroundColor: '#ffffff', borderTopLeftRadius: 32, borderTopRightRadius: 32, paddingBottom: 40, shadowColor: '#000', shadowOffset: { width: 0, height: -10 }, shadowOpacity: 0.1, shadowRadius: 20, elevation: 20 },
    header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 24, borderBottomWidth: 1, borderBottomColor: '#f8fafc' },
    title: { fontSize: 20, fontWeight: '800', color: '#0f172a' },
    closeBtn: { padding: 8, backgroundColor: '#f1f5f9', borderRadius: 99 },
    itemPreview: { padding: 20, backgroundColor: '#f8fafc', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#f1f5f9' },
    previewName: { fontSize: 18, fontWeight: '700', color: '#475569' },
    optionsContainer: { padding: 20, gap: 12 },
    optionBtn: { flexDirection: 'row', alignItems: 'center', padding: 16, backgroundColor: '#f8fafc', borderRadius: 20, borderWidth: 1, borderColor: '#f1f5f9' },
    optionBtnRed: { flexDirection: 'row', alignItems: 'center', padding: 16, backgroundColor: '#fff1f2', borderRadius: 20, borderWidth: 1, borderColor: '#ffe4e6' },
